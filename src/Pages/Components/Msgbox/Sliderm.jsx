...
export default () => {
  ...
  return (
    ...
    >
      ...
      <SwiperSlide><Msgbox Designation='Dean' Image='dean.jpg' Department='Faculty of Engineering & Technology,ZHCET' Content='Students from SAE-ZHCET proved they are as capable as students from IITs, NITs, and other renowned universities by creating a variety of automobiles in several industries and winning multiple competitions. I am thus quite pleased with all of the efforts made by our students since this speaks well of their original thought.' Name='Prof. Mohammad Altamush Siddiqui' /></SwiperSlide>
