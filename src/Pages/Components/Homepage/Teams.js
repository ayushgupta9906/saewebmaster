...
function Teams() {
  ...
  return (
    ...
    <div className='teammaincontainer'  data-aos='fade-up' data-aos-duration='1000' data-aos-delay='300' >
        
      {/*<div className='traingle'></div> */}
        <div className='teaminside'>
           
            <div className='teamheading'>OUR TEAMS</div>
            <div className='teamheadingdesc'>Meet the dynamic teams fueling innovation at the our Club</div>
            ...
            <Card
              Title="Zhcet Formula Racing Electric"
              
              Description="The students of the ZHCER Formula Racing Club launched ZFR Electric in 2021. It symbolizes a leap towards the future as the automobile industry gradually trans......."
              Id="zfr-ev"
              Image="zfrevteam.jpg"
              Linkedin='https://www.linkedin.com/company/zhcet-formula-racing-zfr/mycompany/'
              Insta='https://www.instagram.com/zhcet_formula_racing/?hl=en'
