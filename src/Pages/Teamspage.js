...
function TeamsPage({Title, Description,State}) {
  ...
  if (State==='EV') {
    ...
    var Rightsideimg="https://drive.google.com/uc?id=1Yhls6CWwvIo4m3MvEUS_uGTRPH-_XZER"
    var Description="The students of the ZHCER Formula Racing Club launched ZFR Electric in 2021. It symbolizes a leap towards the future as the automobile industry gradually transitions to a low-pollution, environmentally friendly world of EVs. The club's objective is to give students who are interested in creating Formula Style Electric Vehicles a space to conceptualize the vehicle and participate in competitions both in India and abroad.  To date, the team has worked on establishing the conceptual design of the EV Powertrain with the aim to compete with the institute's maiden EV in the Formula Bharat 2024 competition."
  }
